...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['Fai schifo!', 0.2], //From 0% to 19%
		['Merd4', 0.4], //From 20% to 39%
		['male', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['uh', 0.69], //From 60% to 68%
		['Nice', 0.7], //69%
		['Bene', 0.8], //From 70% to 79%
		['Non Male!', 0.9], //From 80% to 89%
		['God', 1], //From 90% to 99%
		['Il Piu Pro!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
